...
1. geef weer dat alle elementen van een gelinkte lijst representatie-objecten zijn (je mag gebruik maken van de functie `getNodeAt(int index)`
2. maak via een stream een deepcopy van een array
3. schrijf een toString die een gelinkte lijst in de vorm "[1, 2, 3]" weergeeft, (als uitdaging) zonder hulpfunctie (hoewel dat een voor de hand liggende oplossing is)
