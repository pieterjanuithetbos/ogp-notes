...
1) Definieer de API
   1.1. Schrijf een regel informele documentatie bij de klasse zelf.
        Wat stelt een instantie voor (onwijzigbare abstractie)
        of wat slaat ze op (wijzigbare abstractie)?
   1.2. Declareer de inspectoren (= getters)
        (= definiëren 'rauwe' abstractetoestandsruimte)
   1.3. Schrijf de abstractetoestandsinvarianten
        (= definieer de geldige abstractetoestandsruimte)
   1.4. Documenteer de constructoren en mutatoren
